...
export const metadata: Metadata = {
  ...
  description:
    "Progettazione architettonica per nuove costruzioni, ville e ristrutturazioni a Belpasso, Catania e provincia. Studio Tecnico Mirone segue il progetto dalle prime idee alla realizzazione.",
  alternates: {
  ...
  openGraph: {
    title: "Progettazione architettonica | Studio Tecnico Mirone",
    description:
      "Progettiamo abitazioni, ville, ristrutturazioni e nuovi spazi a Belpasso, Catania e in Sicilia.",
  ...
  twitter: {
    ...
    title: "Progettazione architettonica | Studio Tecnico Mirone",
    description:
      "Progettazione di abitazioni, ville, ristrutturazioni e nuove costruzioni a Belpasso e Catania.",
  },
};
...
const config: ServiceDetailConfig = {
  ...
  locationLabel: "Belpasso · Catania · Sicilia",

  titleFirstLine: "Progettazione",
  titleSecondLine: "architettonica",

  heroDescription:
    "Trasformiamo esigenze, idee e possibilità concrete in spazi funzionali, riconoscibili e realizzabili. Seguiamo progetti di nuove costruzioni, ville e ristrutturazioni a Belpasso, Catania e provincia.",
  ...
  introduction: {
    ...
    title: "Dall’idea iniziale a un progetto concreto.",
    paragraphs: [
  ...
  areas: {
    ...
    title: "Progetti pensati per essere vissuti e realizzati.",
    description:
      "Ogni intervento viene sviluppato considerando contemporaneamente qualità architettonica, funzionalità, vincoli tecnici e sostenibilità economica.",
    ...
    cards: [
      {
        ...
        description:
          "Progettazione di case unifamiliari, ville contemporanee e residenze studiate sulle esigenze della famiglia.",
      },
      {
        icon: Building2,
        title: "Nuove costruzioni",
        description:
          "Sviluppo completo del progetto, dalla fattibilità iniziale fino agli elaborati necessari per la realizzazione.",
      },
      {
        icon: PencilRuler,
        title: "Ristrutturazioni",
        description:
          "Riorganizzazione degli spazi, ampliamenti, recupero degli immobili e valorizzazione del patrimonio esistente.",
      },
      {
        icon: Layers3,
        title: "Spazi interni",
        description:
          "Distribuzione funzionale degli ambienti, studio dei percorsi, illuminazione, materiali e rapporto tra interno ed esterno.",
      },
    ],
  },
  ...
  workflow: {
    ...
    title: "Sei fasi, un unico percorso.",
    description:
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "Analizziamo la situazione urbanistica, edilizia e catastale per verificare la fattibilità del progetto prima di svilupparlo.",
      },
      {
        number: "03",
      ...
      },
      {
        ...
        description:
          "Produciamo elaborati grafici, prospetti, sezioni, dettagli e rappresentazioni tridimensionali utili a comprendere ogni scelta.",
      },
      {
        number: "05",
  ...
  benefits: {
    ...
    title: "Un progetto chiaro prima di iniziare il cantiere.",
    description:
  ...
  deliverables: {
    ...
    title: "Cosa può comprendere l’incarico.",
    description:
  ...
  locations: {
    ...
    title: "Progettazione a Belpasso e in provincia di Catania.",
    description:
      "La sede dello Studio è a Belpasso. Seguiamo incarichi nei comuni etnei, a Catania e nel territorio provinciale, valutando anche progetti nel resto della Sicilia e in Italia.",
  ...
  faqs: {
    ...
    title: "Informazioni sulla progettazione architettonica.",

    items: [
      {
        question: "Quanto costa un progetto architettonico?",
        answer:
      ...
      {
        question: "È possibile richiedere solo uno studio preliminare?",
        answer:
      ...
      {
        question: "Lo Studio segue anche le pratiche edilizie?",
        answer:
      ...
      {
        question: "Posso vedere il risultato prima dell’inizio dei lavori?",
        answer:
      ...
      {
        question: "Seguite anche la direzione dei lavori?",
        answer:
      ...
      },
      {
        ...
        answer:
          "La sede è a Belpasso e lo Studio opera principalmente a Catania e provincia, nei comuni etnei e, in funzione dell’incarico, anche nel resto della Sicilia e sul territorio nazionale.",
      },
    ],
  },
...
const jsonLd = {
  ...
  "@graph": [
    ...
    {
      "@type": "Service",
      "@id": `${SITE_URL}/servizi/progettazione-architettonica/#service`,
    ...
    {
      "@type": "BreadcrumbList",
      "@id": `${SITE_URL}/servizi/progettazione-architettonica/#breadcrumb`,
      itemListElement: [
        {
          "@type": "ListItem",
          position: 1,
        ...
        },
        {
          ...
          position: 3,
          name: "Progettazione architettonica",
          item: `${SITE_URL}/servizi/progettazione-architettonica`,
        },
      ],
    },
  ],
...
export default function ProgettazioneArchitettonicaPage() {
  return <ServiceDetailPage config={config} jsonLd={jsonLd} />;
}